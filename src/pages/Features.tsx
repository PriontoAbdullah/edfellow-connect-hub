...
const Features = () => {
  ...
  const universityFeatures = [
    ...
    },
    {
      ...
      description: "Attract and connect with qualified faculty members from around the world."
    },
    {
      icon: Network,
      ...
      <section className="relative py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-600 mb-8 sm:mb-12 leading-relaxed">
            Discover the comprehensive tools and features that make Edfellow the premier platform for global education collaboration.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gray-50/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-600">Essential tools for all users on the Edfellow platform</p>
          </div>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Student-Specific Features</h3>
            <p className="text-lg sm:text-xl text-gray-600">Tools designed to enhance your learning journey and career development</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {studentFeatures.map((feature, index) => (
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-blue-50 to-indigo-50 hover:scale-105">
                <CardHeader className="text-center p-6 sm:p-8">
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gray-50/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Professor-Specific Features</h3>
            <p className="text-lg sm:text-xl text-gray-600">Advanced tools for teaching, mentoring, and building your academic practice</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {professorFeatures.map((feature, index) => (
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-green-50 to-emerald-50 hover:scale-105">
                <CardHeader className="text-center p-6 sm:p-8">
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">University-Specific Features</h3>
            <p className="text-lg sm:text-xl text-gray-600">Comprehensive solutions for institutional growth and global reach</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {universityFeatures.map((feature, index) => (
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-orange-50 to-amber-50 hover:scale-105">
                <CardHeader className="text-center p-6 sm:p-8">
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl mb-8 sm:mb-12 opacity-90">
            Join Edfellow today and unlock the full potential of global education collaboration.
          </p>
