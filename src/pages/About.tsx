  ...
  const values = [
    {
      ...
      description: "Breaking down geographic barriers to create meaningful educational connections worldwide."
    },
    {
      icon: Users,
      title: "Inclusive Community",
      description: "Building a diverse, welcoming space where all learners and educators can thrive."
    },
    {
      icon: BookOpen,
      title: "Knowledge Sharing",
      description: "Facilitating the free exchange of ideas, expertise, and educational resources."
    },
    {
      icon: Lightbulb,
      title: "Innovation",
      description: "Continuously evolving to meet the changing needs of global education."
    },
    {
      icon: Award,
      title: "Excellence",
      description: "Maintaining high standards in education quality and user experience."
    },
    {
      icon: Handshake,
      title: "Collaboration",
      description: "Fostering partnerships that strengthen the global academic community."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50/20 via-blue-50/10 to-purple-50/20">
      ...
      <section className="relative py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-600 mb-8 sm:mb-12 leading-relaxed">
            Edfellow is a global education platform designed to connect students, professors, and universities in a meaningful and collaborative way.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12">
            <Card className="relative overflow-hidden border-0 shadow-2xl bg-gradient-to-br from-blue-600 to-purple-600 text-white">
              ...
              <CardHeader className="relative z-10 p-6 sm:p-8">
                ...
                <CardTitle className="text-2xl sm:text-3xl font-bold mb-4">Our Vision</CardTitle>
            ...
            <Card className="relative overflow-hidden border-0 shadow-2xl bg-gradient-to-br from-purple-600 to-pink-600 text-white">
              ...
              <CardHeader className="relative z-10 p-6 sm:p-8">
                ...
                <CardTitle className="text-2xl sm:text-3xl font-bold mb-4">Our Mission</CardTitle>
                <CardDescription className="text-purple-100 text-base sm:text-lg leading-relaxed">
                  Edfellow empowers learners and educators by connecting them across continents through mentorship, 
                  shared knowledge, and accessible academic opportunities. We facilitate meaningful collaborations that 
                  enrich education, foster career growth, and build a diverse, global academic community.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Our Story</h3>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-purple-600 mx-auto rounded-full mb-8"></div>
          </div>
          
          <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
            <p className="text-base sm:text-lg">
              At its heart, Edfellow breaks down geographic and institutional barriers to make education more accessible, 
              personalized, and globally connected. Whether you're a student seeking to deepen your knowledge, a professor 
              ready to share your expertise across borders, or a university aiming to reach a wider international audience—Edfellow 
              brings the academic world together.
            </p>
            
            <p className="text-base sm:text-lg">
              Imagine discussing your major with a student halfway across the world and discovering how your field is taught, 
              applied, and valued in a completely different cultural and educational context. This kind of global exchange enriches 
              your academic journey, challenges your thinking, and prepares you for success in an interconnected world.
            </p>
            
            <p className="text-base sm:text-lg">
              Edfellow gives students the opportunity to connect with peers in their field worldwide, share insights, and learn 
              from diverse academic experiences. Through access to global mentoring, academic guidance, and career counseling, 
              students can explore career paths, build skills, and make informed decisions about their futures.
            </p>
            
            <p className="text-base sm:text-lg">
              For universities, Edfellow offers a powerful platform to expand international reach, promote academic programs, 
              and attract both students and faculty from across the globe. Together, we're building a truly global academic ecosystem.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-white/30 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Our Values</h3>
            ...
            {values.map((value, index) => (
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white/80 backdrop-blur-sm">
                <CardHeader className="text-center p-6 sm:p-8">
                  ...
                  <CardTitle className="text-xl sm:text-2xl font-bold text-gray-900 mb-3">{value.title}</CardTitle>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl mb-8 sm:mb-12 opacity-90">
            Be part of the future of education. Connect, learn, and grow with Edfellow.
          </p>
