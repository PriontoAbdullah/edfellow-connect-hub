...
const UniversitySubmitProgram = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Your program has been submitted for review and will be published soon.",
    });
  };
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={formData.programType} onValueChange={(value) => setFormData(prev => ({ ...prev, programType: value }))}>
                        <SelectTrigger>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="flex items-center space-x-2 pt-8">
                      <input
                        ...
                        onChange={(e) => setFormData(prev => ({ ...prev, scholarships: e.target.checked }))}
                        className="rounded"
                      />
                      <Label htmlFor="scholarships">Scholarships Available</Label>
                    </div>
                  </div>
                </div>
