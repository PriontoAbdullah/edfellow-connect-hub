...
import { Users, Search, Plus, MessageSquare, Calendar, Globe, Lock, TrendingUp, Star } from 'lucide-react';
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Connect with global academic communities</p>
        </div>
        <Button 
