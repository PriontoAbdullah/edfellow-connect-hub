...
const ProfessorMentorship = () => {
  ...
  const [scheduleAction, setScheduleAction] = useState<'accept' | 'reschedule'>(
    'accept'
  );
  ...
  const mentorshipRequests = [
    {
      ...
      year: 'Junior',
      message:
        'I am interested in AI research and would love guidance on choosing the right PhD programs and developing my research skills.',
    ...
    },
    {
      ...
      year: 'Senior',
      message:
        'Seeking mentorship for my capstone project on natural language processing and career advice for industry transitions.',
    ...
    },
    {
      ...
      year: 'Graduate',
      message:
        'Looking for guidance on research methodologies and publication strategies for my thesis on optimization algorithms.',
  ...
  return (
    <div className='p-6 space-y-6'>
      ...
      <div className='flex justify-between items-center'>
        <div>
          ...
          <p className='text-gray-600'>
            Manage mentorship requests and current mentees
          </p>
        </div>
                ...
                <CardContent className='space-y-4'>
                  ...
                  <div className='flex gap-3 pt-4 border-t'>
                    ...
                    <Button
                      ...
                      className='flex-1'
                      onClick={() => {
                        setSelectedStudentForChat(request.student);
                ...
                <CardContent className='space-y-4'>
                  ...
                  <div className='flex gap-2'>
                    <Button
                      ...
                      onClick={() => {
                        setSelectedStudentForChat(mentee.name);
                        setChatModalOpen(true);
                      }}
                    >
      ...
      <ChatModal
        ...
        recipientName={selectedStudentForChat}
