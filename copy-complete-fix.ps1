# PowerShell script to copy the COMPLETE table fix to clipboard
$sql = @"
...
Write-Host "🚨 COMPLETE TABLE FIX COPIED TO CLIPBOARD!" -ForegroundColor Red
Write-Host ""
Write-Host "⚠️  WARNING: This will DELETE all existing group_posts data!" -ForegroundColor Yellow
Write-Host ""
...
Write-Host ""
Write-Host "This will create the complete group_posts table with ALL required columns!" -ForegroundColor Cyan
